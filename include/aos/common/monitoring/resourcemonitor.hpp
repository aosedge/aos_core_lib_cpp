...
private:
    ...
    StaticArray<AlertProcessor, cMaxAlertProcessorsPerInstance> mAlertProcessors;
    StaticMap<StaticString<cInstanceIDLen>, StaticArray<AlertProcessor, cMaxAlertProcessorsPerInstance>,
        cMaxNumInstances>
        mInstanceAlertProcessors;
