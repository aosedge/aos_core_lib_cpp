...
* [aos::cm::monitoring::Average](average.hpp) - calculates average monitoring data over a period of time;
* [aos::cm::monitoring::AlertProcessor](alertprocessor.hpp) - processes monitoring data against alert rules
...
The monitoring module uses the [aos::instancestatusprovider::ListenerItf](../instancestatusprovider/itf/instancestatusprovider.hpp)
