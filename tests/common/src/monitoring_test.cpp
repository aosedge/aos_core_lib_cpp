    ...
    *providedNodeMonitoringData = {};
    ...
    EXPECT_TRUE(monitor
                    ->StartInstanceMonitoring("instance0",
                        {instance0Ident, instancePartitions, 0, 0, Optional<AlertRules> {instanceAlertRules}})
                    .IsNone());
    EXPECT_TRUE(monitor
                    ->StartInstanceMonitoring("instance1",
                        {instance1Ident, instancePartitions, 0, 0, Optional<AlertRules> {instanceAlertRules}})
                    .IsNone());
